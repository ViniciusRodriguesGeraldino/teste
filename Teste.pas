...
begin
  ...
  begin
    ...
    ClientDataSet1DESCRICAO.AsString     := pedClass.getDescricaoProduto(sqlQuery.FieldByName('CODIGOPRODUTO').AsString);
...
begin
  pedClass.Salva(edtPed.Text, edtDataEmissao.Text, edtCliente.Text, StrToCurrDef(Copy(lblTotal.Caption, 8, 100), 0), ClientDataSet1);
  ShowMessage('OK');
end;
